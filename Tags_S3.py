...
# Connect to S3  
s3 = boto3.client('s3', aws_access_key_id='AKIATIOAOM2VBFABJL4U', aws_secret_access_key='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')
bucket_name = 'assign5adm'

# Connect to ChatGPT API
openai.api_key = "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"
...
def form_and_table_understanding(image_path, prompt_text,key):
  ...
  headers = {"Content-Type": "application/json","Authorization": f"Bearer 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"}
  payload = {
